...
class MedXpertQA(BaseDataset):
    ...
    def load_data(self):
        dataset = load_dataset(self.hf_path, self.split, cache_dir=self.dataset_path)[
            "test"
        ]
    ...
    def cal_metrics(self, out_samples):
        ...
        metrics = {
            ...
            "task type metrics": task_type_metrics,
        }
        ...
        if not os.path.exists(self.dataset_path):
            ...
            if len(os.listdir(img_path)) == 0:
                ...
                self._unzip_img_zip_local(
                    local_path=self.dataset_path, zip_filename="images.zip"
                )
